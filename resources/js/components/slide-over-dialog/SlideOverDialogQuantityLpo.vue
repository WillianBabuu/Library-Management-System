                    ...
                    <form class="flex-1 flex flex-col" @submit.prevent="savePriceQuantity">
                        ...
                        <div class="flex-1 relative">
                            ...
                            <div class="absolute inset-0 overflow-y-scroll  py-6 px-4">
                                ...
                                <div class="relative w-full group">
                                    <label for="name" class="block mb-2 text-sm font-medium text-gray-800">Buying Price</label>
                                ...
                                <div class="relative w-full group">
                                    <label for="name" class="block mb-2 text-sm font-medium text-gray-800">Selling Price</label>
...
<script>
    ...
    import itemLpoService from "@services/item-lpo-service.js";
    ...
    export default {
        ...
        data() {
            return {
                form: {
                    id: '', form_method: '', quantity: 0, lpo_id: '', item_id: '', buying_price: 0, selling_price: 0
                },
        ...
        methods: {
            async savePriceQuantity() {
                if (this.isSales){
                    itemLpoService.action(this.form, (results)=>{
                        this.isOpen = false;
                        this.isSales = false;
                        const category = results.returnData;
                        this.$emit("refreshDocumentItems")
                        this.form = {
                        id: '', amount: 0,quantity: 0, buying_price: 0
                        }
                        Swal.fire({
            ...
            setIsOpen(value, isSales,item = null) {
                ...
                if(item) {
                    ...
                    this.form.lpo_id = item.lpo_id;
                    this.form.item_id = item.item_id;
                    this.form.form_method = 'update';
                    this.form.buying_price = item.buying_price;
