                        ...
                        <div class="flex-1 relative">
                            ...
                            <div class="absolute inset-0 overflow-y-scroll  py-6 px-4">
                                ...
                                <div class="relative w-full group">
                                    ...
                                    <input type="text" id="quantity" v-model="form.quantity" class="box-border text-black placeholder-gray-400
...
<script>
    ...
    import itemTransferService from "@services/item-transfer-service.js";
    ...
    export default {
        ...
        data() {
            return {
                form: {
                    id: '', form_method: '', quantity: '', available: '', item_id: '', store_id: '',
                },
        ...
        methods: {
            async savePriceQuantity() {
                itemTransferService.action(this.form, (results)=>{
                    this.isOpen = false;
            ...
            setIsOpen(value, item = null, store_id) {
