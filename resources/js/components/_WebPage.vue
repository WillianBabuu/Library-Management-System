    ...
    <header class="relative z-50 w-full h-24">
        <div
            ...
            <a href="/" class="relative flex items-center inline-block h-5 h-full font-black leading-none">
                ...
                <span class="ml-3 text-xl text-gray-800">Laravel Vue SP<span class="text-pink-500">.</span></span>
            </a>
            ...
            <div
                ...
                <router-link to="login"
                             class="relative z-40 px-3 py-2 mr-0 text-sm font-bold text-pink-500 md:px-5 lg:text-white sm:mr-3 md:mt-0">Login</router-link>
