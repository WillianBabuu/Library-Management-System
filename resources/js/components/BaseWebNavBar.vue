    ...
    <div class="container w-full">
        <div x-data="{ open: false }"
            ...
            <div class="flex flex-row items-center justify-between lg:justify-start">
                <router-link to="/"
                   class="text-lg font-bold tracking-tighter text-blue-600 transition duration-500 ease-in-out
                   transform tracking-relaxed lg:pr-8">
                    Laravel Stater Pack
                </router-link>
              ...
              ">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100"
                        ...
                        <div class="px-2 py-2 bg-white rounded-md shadow">
                            <a class="block px-4 py-2 mt-2 text-sm text-gray-500 md:mt-0 hover:text-blue-600
                ...
                <div class="inline-flex items-center gap-2 list-none lg:ml-auto">
                    <base-btn-outline btn-color="indigo" btn-label="Login" @click="this.$router.push({ name : 'login' })"
                                      class="rounded-xl px-10 py-3 text-base font-medium text-center"/>
                    <base-btn btn-color="indigo" btn-label="Signup" @click="this.$router.push({ name : 'signup' })"
                              class="rounded-xl px-10 py-3 text-base font-medium text-center"/>
                </div>
            </nav>
        </div>
...
<script>
    ...
    import BaseBtnOutline from "./BaseBtnOutline";
    export default {
        name: 'base-web-nav-bar',
        components: {BaseBtnOutline, BaseBtn},
    }
</script>
