<template>
    <Combobox v-model="selected">
        <div class="relative mt-1">
            <div
                class="relative w-full text-left bg-white rounded-lg shadow-md cursor-default
                focus:outline-none focus-visible:ring-2 focus-visible:ring-opacity-75 focus-visible:ring-white
                focus-visible:ring-offset-indigo-300 focus-visible:ring-offset-2 sm:text-sm overflow-hidden">
                <ComboboxInput
            ...
            <TransitionRoot
                ...
                @after-leave="query = ''" >
                <ComboboxOptions
                    class="absolute w-full py-1 mt-1 overflow-auto text-base bg-white
                    ...
                    <ComboboxOption
                        ...
                        <li
                            ...
                            :class="{ 'text-white bg-indigo-600': active, 'text-gray-900': !active, }" >
                            <span
