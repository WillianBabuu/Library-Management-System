                ...
                <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 lg:w-96">
                    <div class="max-w-md w-full space-y-8">
                        <div>
                            ...
                            <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">SIGNUP</h2>
                        ...
                        <form class="mt-8 space-y-6" @submit.prevent="registerAccount">
                            ...
                            <div class="rounded-md shadow-sm -space-y-px">
                                <div>
                                   ...
                                   focus:border-indigo-500 focus:z-10 sm:text-sm "
                                    :class="errors.name ? 'border-red-500' : 'border-gray-300'" placeholder="Full Name" />
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <input id="terms_and_condition" v-model="form.terms_and_condition" type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border rounded" :class="errors.password_confirmation ? 'border-red-500' : 'border-gray-300'"/>
                                    <label for="terms_and_condition" class="ml-2 block text-sm text-gray-900">Agree to our terms and condition </label>
                                    <p class="text-red-500 text-xs italic"  v-if="errors.terms_and_condition">{{ errors.terms_and_condition[0] }}</p>
                                </div>
                            </div>
